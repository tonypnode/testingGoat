"""
Django settings for testingGoat project.
...
SECRET_KEY = 'w5%+4yntu=7lwzmh_+!w&w##&5nq49d_^!%2+*$)0+^^f*&8h#'
...
WSGI_APPLICATION = 'testingGoat.wsgi.application'
